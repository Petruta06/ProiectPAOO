...
public class Game implements Runnable
{
    ...
    public ScoreDataBase db;               /*!< Reference to the database.*/
    ...
    public void run()
    {
        ...
        final double timeFrame      = 100000000 / framesPerSecond; /*!< Durata unui frame in nanosecunde.*/
