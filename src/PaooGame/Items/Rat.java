...
public class Rat extends Item {
    ...
    public Rat(RefLinks refLink, float x, float y) {
        super(refLink, x, y, Tile.TILE_WIDTH*2, Tile.TILE_HEIGHT*2);
    ...
    @Override
    protected void die() {
        refLink.GetMap().getScore().addPoints(700);
    }
    ...
    public void Draw(Graphics g) {
        g.drawImage(image, (int) (x - refLink.getCamera().getxOffset()), (int) (y - refLink.getCamera().getyOffset()), width/2, height/2, null);
    }
