...
public class CharacterSheet {
    ...
    private static int    tileWidth = 24;   /*!< Latimea unei dale din sprite sheet.*/
    private static int    tileHeight = 30;   /*!< Inaltime unei dale din sprite sheet.*/
     ...
     */
    public CharacterSheet(BufferedImage buffImg)
    {
